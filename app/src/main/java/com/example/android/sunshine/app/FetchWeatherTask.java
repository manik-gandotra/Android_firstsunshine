...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                ContentValues[] vals=new ContentValues[cVVector.size()];
                cVVector.toArray(vals);
                int bulkInsert=mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI,vals);
            }
    ...
    protected String[] doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 14;
        String key="bf569f3eaa81914b77500ff4f55ed5a9";
        ...
        try {
            ...
            final String API_K="APPID";
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    .appendQueryParameter(QUERY_PARAM, params[0])
                    .appendQueryParameter(FORMAT_PARAM, format)
                    .appendQueryParameter(UNITS_PARAM, units)
                    .appendQueryParameter(DAYS_PARAM, Integer.toString(numDays))
                    .appendQueryParameter(API_K,key)
                    .build();
